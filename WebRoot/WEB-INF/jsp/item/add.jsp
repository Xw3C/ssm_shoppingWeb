...
<div class="panel admin-panel">
   ...
   <div class="body-content">
       ...
       <div class="form-group">
           <div class="label"><label>新增商品名称:</label></div>
           <div class="field">
           ...
           <div class="form-group">
               <div class="label"><label>新增商品价格:</label></div>
               <div class="field">
           ...
           <div class="form-group">
               <div class="label"><label>新增商品折扣:</label></div>
               <div class="field">
           ...
           <div class="form-group">
               <div class="label"><label>新增商品类别:</label></div>
               <div class="field">
           ...
           <div class="form-group">
               <div class="label"><label>副图5:</label></div>
               <div class="field">
                   <input type="file" class="input w50" name="file" />
                   <div class="tips"></div>
               </div>
           ...
           <div class="form-group">
               ...
               <div class="field">
                   ...
                   <script type="text/javascript">
                       var editer =UE.getEditor('remark_txt_1');
